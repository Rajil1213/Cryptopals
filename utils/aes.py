        ...
        for i in range(cols):
            for j in range(diffRows):
                ...
                for k in range(rows):
                    ...
                    shiftMatElem = shiftedMatrix[k][i]
                    product = self.gfMul(diffElem, shiftMatElem) # self.GF.Multiply(diffElem, shiftMatElem)
                    total ^= product
                productMatrix[j][i] = hex(total)
